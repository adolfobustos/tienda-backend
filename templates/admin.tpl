...
<div class="contenedor">
  <h2>Usuarios</h2>
  <section>
    <!-- Alerta Delete Usuario -->
    <div class="alert alert-warning" role="alert">
      Al eliminar un usuario, se eliminan las actividades relacionadas como "comentar".
    </div>
    <!-- Tabla Usuarios -->
    <div class="col-10 bg-white text-dark table-responsive">
      <table class="table table-bordered mb-0">
        <thead>
          <tr>
            <th>Usuario</th>
            <th class="text-center"><span class="text-warning">Usuario(0) Administrador(1)</span></th>
            <th></th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            <td class="text-dark">{$user['user']}</td>
            <td class="text-center">{$user['rol']}</td>
            <td class="text-center">
              <!-- EDIT -->
              <a href="editUser/{$user['id']}" type="button" class="btn btn-outline-warning d-inline-flex m-0 p-1">
              ...
              <!-- DELETE -->
              <a href="deleteUser/{$user['id']}" type="button" class="btn btn-outline-danger d-inline-flex m-0 p-1">
